...
from app.teams.loader import load_app_config_from_db
...
# NOTE: In a real application, you might have a more dynamic way to load these,
...
HIERARCHICAL_REGISTRY, all_worker_nodes = load_app_config_from_db()
